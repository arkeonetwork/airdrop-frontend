...
export const ProtoInt64: MessageFns<ProtoInt64> = {
  encode(message: ProtoInt64, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.value !== 0) {
...
export const ProtoUint64: MessageFns<ProtoUint64> = {
  encode(message: ProtoUint64, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.value !== 0) {
...
export const ProtoAccAddresses: MessageFns<ProtoAccAddresses> = {
  encode(message: ProtoAccAddresses, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
...
export const ProtoStrings: MessageFns<ProtoStrings> = {
  encode(message: ProtoStrings, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    for (const v of message.value) {
...
export const ProtoBools: MessageFns<ProtoBools> = {
  encode(message: ProtoBools, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {

...
export const QueryGroupsRequest = {
  ...
  decode(input: Reader | Uint8Array, length?: number): QueryGroupsRequest {
    const reader = input instanceof Uint8Array ? new Reader(input) : input;
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const QueryGroupsResponse = {
  ...
  decode(input: Reader | Uint8Array, length?: number): QueryGroupsResponse {
    const reader = input instanceof Uint8Array ? new Reader(input) : input;
    let end = length === undefined ? reader.len : reader.pos + length;
...
export class QueryClientImpl implements Query {
  ...
  Groups(request: QueryGroupsRequest): Promise<QueryGroupsResponse> {
    ...
    return promise.then((data) => QueryGroupsResponse.decode(new Reader(data)));
  }
}

  ...
  return (
    <>
      ...
      >
        ...
        >
          <Text textAlign="center" fontWeight="bold" mx="30px">
            Wait!! You are not done! <br />
            Please stake and vote on the Arkeo network to claim the rest of your
            airdrop.
          </Text>
        </MotionFlex>
        <MotionBox
        ...
        >
          ...
          >
            ...
            >
              ...
              <Flex>
                <Text>{toDecimal(totalClaimAmount)} ARKEO</Text>
                <ArrowForwardIcon
                  width="24px"
                  height="24px"
                  padding="4px"
